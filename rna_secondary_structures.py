...
# Read data
rna = ""
with open("tmp/rosalind_pmch.txt", "r") as f:
	lines = f.readlines()
	for line in lines:
...
# Compute the total possible number of perfect matchings of basepair edges in the bonding graph of s
total = math.factorial(rna.count("A")) * math.factorial(rna.count("G"))
print(total)
